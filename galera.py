...
transaction_num = 20 # transacion num of each client
...
try:
    ...
    for opt, arg in opts:
        if opt in ('-w','--wo_rate'):
            ...
            print("python3 galera.py -w <wo_rate> -r <ro_rate> -p <w_percent> -t <trans_num> -o <op_num> -c <client_num> -n <node_no> -f <folder_num>")
            sys.exit()
